...
import { Mail, Lock, Eye, EyeOff, Sparkles, BookOpen, TrendingUp, Users, Trophy, ShieldCheck, Headphones, Loader2 } from 'lucide-react';
import { useAppDispatch, useAppSelector } from '@/lib/hooks';
import { googleSignInUser, loginUser } from '@/lib/features/user/userSlice';
      ...
      <div className="max-w-6xl w-full mx-auto my-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-6">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 leading-tight tracking-tight">
            Continue your learning journey with <span className="text-emerald-600">Ŋwà'</span>
          </h1>

          <p className="text-sm text-slate-500 leading-relaxed">
            Log in to access your study plans, progress, achievements and more.
          </p>
            ...
            {[
              {
                ...
                desc: 'Continue your lessons and practice seamlessly across all your devices.',
              },
              {
                icon: TrendingUp,
                iconBg: 'bg-blue-500/10 text-blue-600',
                title: 'Track your progress',
                desc: 'View your performance, goals and achievements in one place.',
              },
              {
                icon: Users,
                iconBg: 'bg-purple-500/10 text-purple-600',
                title: 'Stay connected',
                desc: 'Engage with your study groups and the Ŋwà\' community.',
              },
              {
                icon: Trophy,
                iconBg: 'bg-amber-500/10 text-amber-600',
                title: 'Achieve more',
                desc: 'Unlock badges, climb the leaderboard and reach your full potential.',
              },
            ].map((feat, i) => (
        ...
        <div className="lg:col-span-7 bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2.5 w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-60 disabled:cursor-not-allowed transition-all shadow-xs"
            >
              {socialLoading ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="remember" className="text-[11px] text-slate-600 font-medium">
                  Remember me
                </label>
              </div>
              <button type="button" className="text-[11px] font-semibold text-emerald-600 hover:underline">
                Forgot password?
              </button>
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold text-xs rounded-xl transition-all shadow-md shadow-emerald-600/20 mt-2 flex items-center justify-center gap-2"
            >
          ...
          {/* Security Badge */}
          <div className="mt-6 flex items-center gap-3 p-3 bg-emerald-50 border border-emerald-100 rounded-xl">
            <div className="w-8 h-8 bg-emerald-500/15 rounded-lg flex items-center justify-center text-emerald-600 shrink-0">
              <ShieldCheck size={18} />
            </div>
            <div>
              <p className="text-[11px] font-bold text-emerald-700">Your learning, your data, your privacy.</p>
              <p className="text-[10px] text-emerald-600/70">We keep your information safe and secure.</p>
            </div>
          </div>
          ...
          <div className="mt-4 flex items-center justify-center gap-4 text-[11px] text-slate-400">
            <span>Need help?</span>
            <button className="flex items-center gap-1 text-emerald-600 font-semibold hover:underline">
